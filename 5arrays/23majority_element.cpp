...
// a. If count is 0, assign the current element as the new candidate and take count as 1.
// b. else If the current element is the same as the candidate, increment count by 1.
// c. else (the current element is different from the candidate) decrement count by 1.
